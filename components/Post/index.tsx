...
const Post = ({ author, image, likes, description, created_at }: PostProps) => {
    ...
    <div>
      ...
      <div className="px-3">
        <h3 className="text-md md:text-lg mb-2">
          It likes to <strong>{likes}</strong> people
        </h3>
      ...
      <span className="px-3 pt-2 pb-3 block text-sm font-medium text-gray-400">
        {created_at}
      </span>
    </div>
  );
